...
void spp_server_main(void)
{
  ...
  while (1) {
    ...
    case gecko_evt_le_connection_opened_id:
    	...
    	GPIO_PinOutClear(BSP_BLE_CONNECTION_PORT, BSP_BLE_CONNECTION_PIN);
    	...
    	gecko_cmd_le_connection_set_parameters(_conn_handle, 24, 40, 0, 0x0c80);
    	break;
    ...
    case gecko_evt_le_connection_closed_id:
    	...
    	GPIO_PinOutSet(BSP_BLE_CONNECTION_PORT, BSP_BLE_CONNECTION_PIN);
