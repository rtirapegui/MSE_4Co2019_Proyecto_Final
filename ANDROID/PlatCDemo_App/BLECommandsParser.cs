...
namespace TPMS_App
{
    class BLECommandsParser
    {
         ...
         * BLE Target protocol:
         *
         * (1 byte)   (1 byte)   (1 byte)      (1 byte)       (pl bytes)  (1 byte)
         *
         *   STX   +   seqNo +   cmdId    +  payloadLength  +  payload  +  ETX
         */
        ...
        const int CMD_FRAME_SIZE_MAX = 20;
        const int CMD_FRAME_RCV_TIMEOUT = 10000;    // In ms
        ...
        // Properties
        public delegate void cmdTableDel_t(int seqNo, int cmdId, byte[] payld);
        ...
        private bool GetCompleteCommand(int b)
        {
            ...
            switch (g_rcvState)
            {
                ...
                case rcvState_t.CMDS_RCV_WAITING_SEQ_NO:
                    {
                        g_rcvState = rcvState_t.CMDS_RCV_WAITING_CMD_ID;

                        // Save current seq_no
                        g_seqNo = b;
                    }
                    break;
                case rcvState_t.CMDS_RCV_WAITING_CMD_ID:
                    {
        ...
        {
            Library.cmdTable(g_seqNo, g_cmdId, g_buff);
        }
